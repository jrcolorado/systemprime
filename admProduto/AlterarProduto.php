...
<div class="container theme-showcase" role="main">      
  ...
  <div class="row">
	<div class="col-md-12">
	  <form class="form-horizontal" method="POST" action="processar/Update_Produto.php" enctype="multipart/form-data">
	   <input type="hidden" name="id" value="<?php echo "$idProd"; ?>">  
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
                            <textarea class="form-control ckeditor" rows="5" name="descricao_curta" placeholder="Descrição curta do produto"> <?php echo $descricao_curta; ?></textarea>
			</div>
		  </div>
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
                            <textarea class="form-control ckeditor" rows="5" name="descricao_longa" placeholder="Descrição longa do produto" ><?php echo $descricao_longa; ?></textarea>
			</div>
		  </div>
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" class="form-control" name="preco" placeholder="Preço" value="<?php echo "$preço"; ?>">
			</div>
		  </div>
                <div class="form-group">
