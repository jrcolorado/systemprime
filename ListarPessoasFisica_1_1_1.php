...
$result_curso = "SELECT * FROM clientes where tipo = '1'";
				...
				<ul class="pagination">
					<li>
						...
						if($pagina_anterior != 0){ ?>
							<a href="ListarPessoasFisica_1_1_1.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
					...
					for($i = 1; $i < $num_pagina + 1; $i++){ ?>
						<li><a href="ListarPessoasFisica_1_1_1.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>
					<?php } ?>
					
					<li>
						<?php
						if($pagina_posterior <= $num_pagina){ ?>
							<a href="ListarPessoasFisica_1_1_1.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
