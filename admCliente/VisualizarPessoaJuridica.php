...
<html>
   ...
   <div class="page-header"></br>
        <h1>Dados do Cliente Pessoa Juridica</h1>
      </div>
      </div>
        ...
        <form class="form-horizontal" method="POST">
              ...
              <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text"  readonly="true" value="<?php echo "$razao_Social"; ?>"class="form-control" name="razao_social" placeholder="Razão Social"   
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text"  readonly="true"    value="<?php echo "$nome_fantasia"; ?>" class="form-control" name="nome_fantasia" placeholder="Razão Social">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text"   readonly="true"   value="<?php echo "$cnpj"; ?>"class="form-control" name="cnpj" placeholder="CNPJ"   
                        ...
                        <div class="form-group">
                            ...
                            <label for="inputbairro" class="col-sm-1 control-label"admCliente/>Bairro</label>
                            <div class="col-sm-3">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <a href='Administrativo.php?link=26'><button type='button' class='btn btn btn-info'>Voltar</button></a>
                    <a href='Administrativo.php?link=31&id=<?php echo $idCliente?>'><button type='button' class='btn btn btn-warning'>Editar</button></a>
                    <a href='Administrativo.php?link=32&id=<?php echo $idCliente?>'><button type='button' class='btn btn btn-danger'>Deletar</button></a>
                    </div>
                    </div>
                </form>
    </body>
