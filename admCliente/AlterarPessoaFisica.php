...
<html>
   ...
   <div class="page-header"></br>
        ...
        <form class="form-horizontal" method="POST" action="processar/Update_PessoaFisica.php">
              <input type="hidden" name="id" value="<?php echo "$idCliente"; ?>"> 
              <div class="form-group">
                            <label for="inputnome" class="col-sm-2 control-label">Nome</label>
                            <div class="col-sm-10">
                                <input type="text" value=" <?php echo $nome; ?>"class="form-control" name="nome" placeholder="Descrição do nome "   
              ...
              <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                     ...
                     <a href='Administrativo.php?link=25'><button type='button' class='btn btn btn-info'>Cancelar</button></a>
                    </div>
                  </div>
