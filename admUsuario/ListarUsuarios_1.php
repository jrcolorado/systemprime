...
$result_curso = "SELECT * FROM usuarios";
...
$result_cursos = "SELECT * FROM usuarios limit $incio, $quantidade_pg";
			 ...
			 <div class="col-md-12">
                <table class="table table-striped" id="myTable">
                    ...
                    <tbody>
                        <tr>
                            <?php
                            $result_cursos = "SELECT * FROM usuarios ORDER BY nome ASC limit $incio, $quantidade_pg";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    $id = $row['nivel_acesso_id'];
                                  
                                    $sql = "SELECT nome_nivel from nivel_acessos where id = '$id'";
                ...
                <strong>Informação!</strong>Nenhum usuario encontrado.
            </div>
                        <?php  
                            }
                            $conn->close();
				...
				<ul class="pagination">
					<li>
						...
						if($pagina_anterior != 0){ ?>
							<a href="ListarUsuarios_1.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
					...
					<li>
						...
						if($pagina_posterior <= $num_pagina){ ?>
							<a href="ListarUsuarios_1.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
