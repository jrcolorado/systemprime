				...
				<ul class="pagination">
					<li>
						...
						if($pagina_anterior != 0){ ?>
							<a href="ListarPessoasFisica_1_1.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
					...
					<li>
						...
						if($pagina_posterior <= $num_pagina){ ?>
							<a href="ListarPessoasFisica_1_1.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
